        ...
        <section style={s.section}>
          ...
          {drafts.length === 0 ? (
            <div style={s.emptyCard}>
              ...
              <p style={s.emptyBody}>
                Write a letter to your future self and seal it for a future date.
              </p>
              ...
              {drafts.map((c) => (
                <div key={c.id} style={s.draftCard}>
                  <div style={s.draftTop}>
                    ...
                    <p style={s.cardDate}>Opens {formatDate(c.deliver_at)}</p>
                  </div>

                  {c.message && (
                    <p style={s.messagePreview}>
                      {c.message.length > 160
                        ? c.message.substring(0, 160) + '...'
                        : c.message}
                    </p>
                  )}
                  ...
                  <div style={s.draftActions}>
                    <button
                      onClick={() => router.push(`/capsule/${c.id}/seal`)}
                      style={s.sealBtn}
                    >
                      Seal &amp; Pay
                    </button>
        ...
        {delivered.length > 0 && (
          <section style={s.section}>
            ...
            <div style={s.deliveredBanner}>
              ...
              <span style={s.deliveredBannerText}>
                ...
                <div key={c.id} style={s.deliveredCard}>
                  ...
                  {c.message && (
                    <div style={s.deliveredMessageBox}>
                      <p style={s.deliveredMessage}>
                        {c.message.length > 240
                          ? c.message.substring(0, 240) + '...'
                          : c.message}
                      </p>
                    </div>
                  )}
                  ...
                  {(c.age || c.city || c.favorite_song || c.favorite_show) && (
                    <div style={s.snapshotRow}>
                      {c.age && (
                        <div style={s.snapshotChip}>
                          <span style={s.chipLabel}>Age</span>
                          <span style={s.chipValue}>{c.age}</span>
                        </div>
                      )}
                      {c.city && (
                        <div style={s.snapshotChip}>
                          <span style={s.chipLabel}>City</span>
                          <span style={s.chipValue}>{c.city}</span>
                        </div>
                      )}
                      {c.favorite_song && (
                        <div style={s.snapshotChip}>
                          <span style={s.chipLabel}>Song</span>
                          <span style={s.chipValue}>{c.favorite_song}</span>
                        </div>
                      )}
                      {c.favorite_show && (
                        <div style={s.snapshotChip}>
                          <span style={s.chipLabel}>Show</span>
                          <span style={s.chipValue}>{c.favorite_show}</span>
                        </div>
                      )}
                    </div>
                  )}
